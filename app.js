...
///////////// Adding event listners - on click to the the hold button.////////////
	...
	document.querySelector('.btn-roll').classList.add('hide-btn');
	document.querySelector('.btn-hold').classList.add('hide-btn');
...
function init() {
		...
		document.querySelector('.btn-roll').classList.remove('hide-btn');
		document.querySelector('.btn-hold').classList.remove('hide-btn');
		$("#crackId").hide();
	}
